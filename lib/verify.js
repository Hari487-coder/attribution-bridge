...
/** One-line human-readable note body for the broker contact. */
function markerNote(marker) {
  return `Assistable attribution verified via master account | evidence=${marker.evidence} | at=${marker.verifiedAt} | sig=${marker.sig}`;
}
