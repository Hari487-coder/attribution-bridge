...
const DEFAULT_CONFIG = {
  ...
  settings: {
    ...
    // "skip" (log only) | "recreate" (delete existing non-INTEGRATION copy, then create)
    ...
    verifiedTag: "assistable-verified",
    verifiedNoteLabel: "Assistable attribution verified via master account",
    // Refuse to bridge a contact whose MASTER record has no genuine opt-in
    // evidence. The core safety gate — leave ON unless you know what you're doing.
    requireMasterEvidence: true,
