...
function seedMocks() {
  ...
  // Master contact: Meta lead-form arrival — genuine ad attribution + integration stamp.
  mockContact({
    id: "master_meta_1",
  ...
  for (const [id, phone] of [
    ...
    // re-verifies opt-in against the LIVE master (it no longer trusts a stored
    // registry status), and the strict gate requires GENUINE attribution.
